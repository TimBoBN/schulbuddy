...
class Config:
    ...
    SESSION_TIMEOUT_MINUTES = int(os.environ.get('SESSION_TIMEOUT_MINUTES', '120'))  # 2 Stunden Standard
    ...
    LOGIN_TIMEOUT_MINUTES = int(os.environ.get('LOGIN_TIMEOUT_MINUTES', '60'))  # 1 Stunde Standard
    MAX_LOGIN_ATTEMPTS = int(os.environ.get('MAX_LOGIN_ATTEMPTS', '5'))
    LOGIN_ATTEMPT_TIMEOUT_MINUTES = int(os.environ.get('LOGIN_ATTEMPT_TIMEOUT_MINUTES', '15'))  # 15 Minuten Sperre
    
    # 2FA-Konfiguration
    TWO_FACTOR_TIMEOUT_MINUTES = int(os.environ.get('TWO_FACTOR_TIMEOUT_MINUTES', '5'))  # 5 Minuten für 2FA
